...
Generative AI tools (ChatGPT by OpenAI, Claude by Anthropic) were used in a limited and supportive role during the development of this project. AI assistance was primarily used for debugging code issues and resolving errors encountered during development, and providing guidance on organizing experiments, collecting metrics, and generating visualizations. All core aspects of the project including the problem definition, algorithm selection, experimental design, implementation decisions, and interpretation of results were all developed and verified by the project team. The team reviewed, tested, and modified any AI-assisted code or suggestions to ensure correctness and alignment with project requirements. No AI-generated content was used without evaluation, and all submissions reflect the team’s own understanding and work.
